...
func go_to_the_loot_screen() -> void:
	print(global.found_moonidol)
	print(global.found_sunidol)
	if global.found_moonidol and global.found_sunidol:
		print("found both")
		Globald.show_dialogue("res://dialogues/pouch.dialogue", "found_both")
		return
	if !global.wearing_moon_idol and !global.wearing_sun_idol:
		var chance = randf()
		if chance < 0.50:
			Globald.show_dialogue("res://dialogues/pouch.dialogue","sun_idol")
			global.found_sunidol = true
			print("found sun")
			print(global.found_sunidol)
			return
		else:
			Globald.show_dialogue("res://dialogues/pouch.dialogue","moon_idol")
			global.found_moonidol = true
			print("found moon")
			print(global.found_moonidol)
			return
	if global.wearing_moon_idol:
		Globald.show_dialogue("res://dialogues/pouch.dialogue" , "sun_idol_conflict")
		global.found_sunidol = true
		print("found sun")
		print(global.found_sunidol)
		return
	if global.wearing_sun_idol:
		Globald.show_dialogue("res://dialogues/pouch.dialogue" , "moon_idol_conflict")
		global.found_moonidol = true
		print("moon idol")
		print(global.found_moonidol)
		return
